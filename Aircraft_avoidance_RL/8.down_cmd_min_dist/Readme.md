# down_cmd_min_dist
아래 방향으로의 학습을 위해, 고도 변화 명령에 관한 reward를 빼고, 충돌에 관련한 reward만을 남겨두었다. "5.down_cmd_dqn_long_sim"과 마찬가지로 시나리오 종료조건이 완화된 상태로 수정되어 학습되었고, reward는 충돌시 -100을 반환하고, 충돌 하지 않은 경우 매 스텝마다 1을 반환하도록 구현되었다. 더 확실한 수렴 양상을 확인해 보기 위해 episodes는 10000으로 설정하였다.

...
class AircraftEnv(gym.Env):
    ...
    def __init__(self, succeed_coef = 8000, collide_coef = -2000, change_cmd_penalty = -200, cmd_penalty = -1, start_cond_coef = 1, cmd_suit_coef = 0.01):
    ...
    def step(self, action):
        ...
        if not done:
            ...
            # 20000 and 1000 are each max value of reward factors
            reward += int(np.abs(self.hdot_cmd) * self.t_step / 20000 * self.cmd_penalty) + int(self.h_cmd_suit / 1000 * self.cmd_suit_coef)
